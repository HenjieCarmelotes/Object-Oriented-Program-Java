...
public class SetCalculator {
	 ...
	 public static void main(String[] args) {
	   ...
	   private static TreeSet<Integer> readSet() {
	      ...
	      TextIO.skipBlanks(); //First skip all the whitespaces.
	      if (TextIO.peek() != '[')
	         throw new IllegalArgumentException("Expected '[' at start of set.");
	      
	      TextIO.getAnyChar(); // Read the '['. //at this point, the computer sees the [ factor.

	      TextIO.skipBlanks(); //skip again the spaces if there is any.
	      if (TextIO.peek() == ']') {
	            // The set has no integers.  This is the empty set, which
	            // is legal.  Return the value.
	         TextIO.getAnyChar(); // Read the ']'.
	         return set; //return the character because this is an empty set.
	      }
