...
public class TransposeGrid {
    ...
    public static int[][] computeTranspose( int[][] matrix ) {
        ...
        int C = matrix[0].length;  // the number of columns in matrix -> This counts the length of the first row.
    ...
    public static void main(String[] args) {
    	...
    	/*Array Direct Assignment Statement Style*/
