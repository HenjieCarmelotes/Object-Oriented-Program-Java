...
/**
 * Note: factorial and fibonacci are really not very good examples of recursion, 
 * since the most natural way to compute them is to use simple for loops. 
 * Furthermore, fibonacci is a particularly bad example, 
 * since the natural recursive approach to computing this function is extremely inefficient.
 * 
 * --- *** ----
...
} //end of class FactorialAndFibonacci
